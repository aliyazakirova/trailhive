  ...
  return (
    <footer className="section-container bg-green-90 text-green-10 py-12">
      <div className="w-full">
        <div className="flex flex-col lg:flex-row justify-between mb-[60px] lg:mb-[80px]">
          ...
          <div className="w-full lg:w-1/3 flex flex-col lg:flex-row justify-between items-start my-4 lg:mb-0">
            <div className="w-1/2">
          ...
          <div className="w-full lg:w-1/3 flex flex-col my-6 lg:my-0">
